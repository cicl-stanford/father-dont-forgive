...
jsPsych.plugins['s_choosing'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html += '<p>' + "One day, the factory committee comes together to discuss the potential production launch of \"SafeSol\". Without April\'s approval, the sun screen will not go into production. April approves the product. <br><br> As a result of the widespread use of \"SafeSol\", several coral reefs get destroyed.<br><br><br><br><br> " + '</p>';
    ...
    for(var p = 0; p < trial.people.length; p++) {
      ...
      if (p == 0) {
        ...
        html += '<p>' + "April is responsible for several coral reefs getting destroyed." + '</p>';
      } else {
        html += '<div id="jspsych-html-slider-response-wrapper">';
        html += '<p>' + "April knew that SafeSol would harm aquatic plants." + '</p>';
      }
