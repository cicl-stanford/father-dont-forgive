/**
 * a jspsych plugin for decision 3-slider response question
 *
 * Sarah Wu
 *
 */
...
jsPsych.plugins['decision'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html += '<div id="jspsych-html-slider-response-stimulus"><div class="row"><img src="' + trial.slide + '" style="width:1250px;"></div></div>';
    html += 'Which game would you rather participate in?'
    ...
    // html += '<img src="images/Experiment 2 Stimulus Materials/Misc/' + trial.people[p] + '.png" style="width:50px;" > </img> </div>';
    // slider bar
    ...
    html += '<span style="text-align: center; font-size: 80%;"> the game <br>on the <b>left</b> </span></div>';
    html += '<div style="display: inline-block; position: absolute; left:50%; text-align: center; width: 100%;">';
    html += '<span style="text-align: center; font-size: 80%;"> the game <br>on the <b>right</b> </span></div>';
