...
jsPsych.plugins['l_knowledge'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html += '<p>' + "One day, the factory committee comes together to discuss the potential production launch of \"HomeStyle\". Without Marc\'s approval, the laundry detergent will not go into production <br><br> Marc approves the product. As a result of the widespread sale of \"HomeStyle\", several local water systems become polluted.<br><br><br><br><br> " + '</p>';
    ...
    for(var p = 0; p < trial.people.length; p++) {
      ...
      if (p == 0) {
        ...
        html += '<p>' + "Marc is responsible for several local water systems being polluted." + '</p>';
      } else {
        html += '<div id="jspsych-html-slider-response-wrapper">';
        html += '<p>' + "Marc knew that HomeStyle would pollute water." + '</p>';
      }
